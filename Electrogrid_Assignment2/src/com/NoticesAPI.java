...
public class NoticesAPI extends HttpServlet {
	...
	{
		// TODO Auto-generated method stub
		String output = noticeObj.inserNotice(request.getParameter("noticeType"), 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) 
			...
			{ 
			 ...
			 paras.get("noticeType").toString(), 
			paras.get("noticeCode").toString(), 
			paras.get("noticeDate").toString(), 
			paras.get("noticeTopic").toString(), 
			paras.get("noticeDesc").toString(), 
			paras.get("noticePerson").toString(), 
			paras.get("noticeMails").toString());
			response.getWriter().write(output); 
			} 
